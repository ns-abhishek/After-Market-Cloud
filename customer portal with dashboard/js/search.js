...
function showAdvancedSearchOptions(container) {
    // Create advanced search options HTML
        ...
        <div class="advanced-search-options">
            ...
            <div class="advanced-search-option">
                <label for="search-exact-match">
                    <input type="checkbox" id="search-exact-match"> Exact Match
                </label>
            </div>
            <div class="advanced-search-option">
                <button class="btn-primary" id="advanced-search-btn">Search</button>
            </div>
        </div>
    `;
    
    // Add advanced options to container
    const advancedSearchToggle = container.querySelector('.advanced-search-toggle');
    advancedSearchToggle.insertAdjacentHTML('afterend', advancedOptionsHTML);
    
    // Hide toggle
    advancedSearchToggle.style.display = 'none';
    
    // Add event listener to search button
    const advancedSearchBtn = container.querySelector('#advanced-search-btn');
    if (advancedSearchBtn) {
        advancedSearchBtn.addEventListener('click', function() {
            ...
            performAdvancedSearch(query, category, dateRange, exactMatch);
            container.innerHTML = '';
            container.style.display = 'none';
        });
    }
